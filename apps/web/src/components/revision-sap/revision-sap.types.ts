...
export interface SapOrder {
  ...
  attemptAt: string | null;
  /**
   * Cuándo ARRANCÓ este bucket. Es lo que permite saber qué órdenes SAP salieron en el
   * mismo envío: los buckets de un envío son contiguos, entre dos envíos hay un hueco.
   *
   * Opcional: el Middleware lo manda desde 1.376.2. Sin él se cae a `attemptAt`, que
   * alcanza salvo que SAP haya tardado mucho en algún bucket.
   */
